    ...
    <Section title="GT League season" eyebrow="Season control" {...control}>
      ...
      <div className="admin-form-grid">
        ...
        <label className="admin-season-completion">
          Championship state
          <span><input type="checkbox" checked={season.isComplete} onChange={(event) => setSeason({ ...season, isComplete: event.target.checked })} /> Season results are final and champions are official</span>
